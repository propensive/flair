...
object Scans:
  ...
  private[flair] val ModifierWords: Set[String] =
    Set
  ...
  private[flair] val DeclKeywords: Set[String] =
    Set("def", "val", "var", "type", "class", "trait", "object", "enum", "given")

  private[flair] val NonOperandWords: Set[String] =
    Set
  ...
  private[flair] def isSymbolicOperator(text: String): Boolean =
  ...
  private[flair] def hasBlankLineBetween
